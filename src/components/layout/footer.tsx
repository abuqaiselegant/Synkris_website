            ...
            <div className="lg:col-span-3 xl:col-span-4">
              <div>
                ...
                <p className="block text-sm text-gray-400 mb-9">
                  Synkris AI builds intelligent voice agents that automate
                  customer calls, bookings, and follow-ups. Designed for
                  businesses that want to scale conversations without increasing
                  headcount.
                </p>
                <div className="flex">
                  <a
            ...
            <div className="lg:col-span-3">
              <div>
                ...
                <p className="block mb-5 text-sm text-gray-400">
                  Get product updates, feature releases, and voice AI insights
        ...
        <div className="container relative z-10 px-5 mx-auto sm:px-7">
          <div className="py-5 text-center">
            <p className="text-sm text-gray-500">
              &copy; {getCurrentYear()} Synkris AI. Built for Intelligent
              Conversations.
            </p>
          </div>
        </div>
